...
$(call inherit-product-if-exists, vendor/htc/eyeatt/eyeatt-vendor.mk)

# overlays
DEVICE_PACKAGE_OVERLAYS += device/htc/eyeatt/overlay
...
PRODUCT_COPY_FILES += \
    ...
    device/htc/eyeatt/configs/com.htc.software.market.xml:system/etc/permissions/com.htc.software.market.xml
...
ifeq ($(TARGET_BUILD_VARIANT),user)
    NFCEE_ACCESS_PATH := device/htc/eyeatt/configs/nfcee_access.xml
else
    NFCEE_ACCESS_PATH := device/htc/eyeatt/configs/nfcee_access_debug.xml
endif
PRODUCT_COPY_FILES += \
